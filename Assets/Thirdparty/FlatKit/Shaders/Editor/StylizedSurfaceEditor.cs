        ...
        foreach (MaterialProperty property in properties) {
            ...
            if (foldoutRemainingItems == 0 && latestFoldoutState) {
                ...
                if (foldoutName.Contains("Advanced Lighting")) {
                    const string m = "<b>Advanced Lighting</b> features are only applicable to real-time lighting. " +
                                     "When using baked lighting the data is immutable because it is included in the " +
                                     "lightmap and/or light probes.";
